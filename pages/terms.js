                        ...
                        <React.Fragment>
                            <div className="titleBarTop">
                                <div className="titleBarTopBg">
                                    <img src={props.pageData['pageInfo']['banner'] ? props.pageData['pageInfo']['banner'] : "/static/images/breadcumb-bg.jpg"} alt={props.t("Terms of Service")} />
                                </div>
...
const Extended = withTranslation('common', { i18n, wait: process.browser })(Terms);
...
Extended.getInitialProps = async function (context) {
    ...
    if (isServer) {
        ...
        const pageData = await axios.get("/terms?data=1");
