...
import CategoryView from "../containers/Category/Index"
...
const Extended = withTranslation('common', { i18n, wait: process.browser })(Category);
...
Extended.getInitialProps = async function(context) {
    ...
    if(isServer){
      ...
      const pageData = await axios.get("/"+context.query.type+"/category/"+context.query.categoryId+"?data=1");
